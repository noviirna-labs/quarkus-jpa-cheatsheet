...
Most boilerplate projects out there fall into two extremes: they are either too complex (overloaded with multi-layer architectures, DTO mappings, and service patterns) or too trivial (simplified apps that sometimes implement database design that is not the best practices). This  often obscures the core mechanics of JPA.
